...
<div class="container">
			...
			<div class="media">
				...
				<div class="media-body">
					<dl class="row">
						...
						<dt class="col-sm-2 offset-sm-1">Date &amp; Time</dt>
						<dd class="col-sm-9">{!! date('l F jS @ g A', strtotime($past["date"])) !!}</dd>
	...
	<!-- Section: Calendar -->
	<h2>Calendar</h2>
	<iframe src="https://calendar.google.com/calendar/embed?src=1n3706c7gs5pdm7f05htfp5k58%40group.calendar.google.com&ctz=America%2FChicago" style="border: 0" width="800" height="600" frameborder="0" scrolling="no"></iframe>
